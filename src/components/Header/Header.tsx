    ...
    <div className='pb-5 pt-2 bg-orange bg-[linear-gradient(-180deg,#f53d2d,#f63)} orange'>
      <div className='container max-w-[1280px]'>
        <div className='flex justify-end items-center  '>
          <Popover
            className="flex relative items-center hover:text-gray-400 cursor-pointer space-x-1"
            renderPopover={
              <>
                <button className="py-1 px-3 w-full text-left text-sm hover:bg-gray-100">
                  Tiếng Việt
                </button>
                <button className="py-1 px-3 w-full text-left text-sm hover:bg-gray-100">
                  English
          ...
          {isAuthenticated && <Popover
            ...
            renderPopover={
              <div className='bg-white rounded shadow-lg'>
                <Link to={path.profile} className='block py-3 px-4 hover:bg-slate-100'>
                  Tài khoản của tôi
                </Link>
                <Link to='/' className='block py-3 px-4 hover:bg-slate-100'>
                  ĐƠn mua
                </Link>
                <button onClick={handleLogout} className='block py-3 px-4 hover:bg-slate-100'>
                  Đăng xuất
                </button>
              </div>
            }
          >
            <div className='w-6 h-6 mr-2'>
              <img
                src='https://th.bing.com/th/id/OIP.nZFUWTV_UVwuPpqURYVzdgHaD4?w=313&h=180&c=7&r=0&o=5&dpr=1.3&pid=1.7'
                alt=''
          ...
          {!isAuthenticated && (<div className='flex items-center'>
            ...
            <Link to={path.login} className='block py-3 px-4 hover:bg-slate-100'>
              Login
            </Link>
        ...
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          <Link to='/' className='col-span-2 flex items-center justify-end'>
            <svg className='flex h-4 lg:h-11 fill-white' viewBox='0 0 192 65'>
              <g fill-rule='evenodd'>
          ...
          <div className="col-span-1 justify-start ">
            ...
            >
              <Link to='/' className='text-white items-center justify-center'>
                <svg
                  className='w-8 h-8'
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
